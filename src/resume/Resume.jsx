...
const Resume = () => {
    return (
        <div className='resume mb-40'>
            <h3 className='sm:mb-10 mt-10'>Working Experiences</h3>
            <div className='resume-list grid sm:grid-cols-4 mt-5'>
                <div className='working-experience col-span-3 sm:grid sm:grid-cols-3 sm:gap-10 mb-10'>
                    <div className='working-name col-span-1 mb-2'>
                        <h5 className='text-customBlue text-xl'>Wheelchair mechanic</h5>
                        <p className='font-bold'>Raamsdonkveer, The Netherlands</p>
                    </div>
                    <div className='working-description col-span-2 mb-8'>
                    ...
                    <div className='working-name col-span-1 mb-2'>
                        <h5 className='text-customBlue text-xl'>Production worker</h5>
                        <p className='font-bold'>Helmond, The Netherlands</p>
                    </div>
                    <div className='working-description col-span-2 mb-8'>
                    ...
                    <div className='working-name col-span-1 mb-2'>
                        <h5 className='text-customBlue text-xl'>Bicycle messenger</h5>
                        <p className='font-bold'>Breda, The Netherlands</p>
                    </div>
                    <div className='working-description col-span-2 mb-8'>
                    ...
                    <div className='working-name col-span-1 mb-2'>
                        <h5 className='text-customBlue text-xl'>Construction worker</h5>
                        <p className='font-bold'>Wellington, New Zealand</p>
                    </div>
                    <div className='working-description col-span-2 mb-8'>
                    ...
                    <div className='working-name col-span-1 mb-2'>
                        <h5 className='text-customBlue text-xl'>Landscaper</h5>
                    ...
                    <div className='working-name col-span-1 mb-2'>
                        <h5 className='text-customBlue text-xl'>Mover</h5>
                        <p className='font-bold'>Perth, Australia</p>
                    </div>
                    <div className='working-description col-span-2 mb-8'>
                    ...
                    <div className='working-name col-span-1 mb-2'>
                        <h5 className='text-customBlue text-xl'>Volunteer</h5>
                        <p className='font-bold'>Breda, The Netherlands</p>
                    </div>
                    <div className='working-description col-span-2 mb-8'>
                    ...
                    <div className='working-name col-span-1 mb-2'>
                        <h5 className='text-customBlue text-xl'>Salesman</h5>
                        <p className='font-bold'>Prinsenbeek, The Netherlands</p>
                    </div>
                    <div className='working-description col-span-2 mb-8'>
                    ...
                    <div className='working-space mb-5'><h3>EDUCATION</h3></div>
                    <div></div>
                    <div></div>
                    <div className='working-name col-span-1 mb-2'>
                        <h5 className='text-customBlue text-xl'>Codecademy</h5>
                        <p className='font-bold'>codecademy.com</p>
                    </div>
                    <div className='working-description education col-span-2 mb-8'>
                        <p>Full-stack Engineer</p>
                        <p>August 2023 - January 2024</p>
                    </div>
                    <div className='working-name col-span-1 mb-2'>
                        <h5 className='text-customBlue text-xl'>Florijn college</h5>
                        <p className='font-bold'>Breda, The Netherlands</p>
                    </div>
                    <div className='working-description education col-span-2'>
                        <p>Retailmanagement</p>
                        <p>2008 - 2011</p>
                    </div>
                </div>
                <div className='extra-info col-span-1 sm:ml-10'>
