...
const Resume = () => {
    return (
        <div className='resume mb-40'>
            <h3 className='mb-10'>Working Experiences</h3>
            <div className='resume-list grid grid-cols-4'>
                <div className='working-experience col-span-3 grid grid-cols-3 gap-10'>
                    <div className='working-name col-span-1'>
                        <h5 className='text-customBlue text-xl'>Wheelchair mechanic</h5>
                        <p>Raamsdonkveer, The Netherlands</p>
                    </div>
                    <div className='working-description col-span-2'>
                    ...
                    <div className='working-space'><h3>EDUCATION</h3></div>
                    <div></div>
                    <div></div>
                    <div className='working-name col-span-1'>
                ...
                <div className='extra-info col-span-1 ml-10'>
